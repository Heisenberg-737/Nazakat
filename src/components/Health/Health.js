          ...
          <div className="bmi__firstPage">
            <div className="bmi__calculatorContainer">
              <div className="bmi__formContainer">
                <h1 className="bmi__calculatorHeading">CALCULATE YOUR BMI</h1>
                <div className="BmiContent"><h3>Your BMI is a measurement that is a ratio of your weight and height. It’s a good way to gauge whether your weight is in healthy proportion to your height. In fact, knowing your BMI can help you – and your GP – determine any health risks you may face if it’s outside of the healthy range.</h3></div>
